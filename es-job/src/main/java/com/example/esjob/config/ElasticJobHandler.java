...
//    private JobEventConfiguration jobEventConfiguration;
    ...
    public void addJob(String jobName, String cron, Integer shardingTotalCount, String id) {
        LiteJobConfiguration jobConfig = simpleJobConfigBuilder(jobName, SimElasticJob.class, shardingTotalCount, cron, id)
                .overwrite(true).build();

//        new SpringJobScheduler(new SimElasticJob(), registryCenter, jobConfig, jobEventConfiguration, elasticJobListener).init();
        new SpringJobScheduler(new SimElasticJob(), registryCenter, jobConfig, elasticJobListener).init();
    }
}
