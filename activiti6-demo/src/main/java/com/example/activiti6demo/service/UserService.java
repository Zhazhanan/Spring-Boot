...
import com.example.activiti6demo.entity.UserGroup;
...
public class UserService {
    ...
    private List<com.example.activiti6demo.entity.User> toMyUser(List<User> userList) {
        List<com.example.activiti6demo.entity.User> myUserList = new ArrayList<>();
        for (User user : userList) {
            com.example.activiti6demo.entity.User myUser = new com.example.activiti6demo.entity.User();
    ...
    public Object addUser(com.example.activiti6demo.entity.User user) {
